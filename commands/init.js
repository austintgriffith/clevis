...
module.exports = async (params)=>{
  ...
  exec('chmod +x *.sh;npm install --save clevis@latest;npm install --save s3;npm install --g mocha;git clone https://github.com/OpenZeppelin/openzeppelin-solidity.git;cd openzeppelin-solidity git pull; git checkout tags/v1.12.0', (err, stdout, stderr) => {
